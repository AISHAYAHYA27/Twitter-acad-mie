...
function findAllTweet()
{
    ...
    //fetch les retweet
    $sql = "SELECT user.id,usr.username AS 'retweetName',tweet.id, user.username, user.display_name, user.picture, tweet.content, tweet.media1, tweet.media2, tweet.media3, tweet.media4, tweet.reply_to,  DATE_FORMAT(retweet.creation_date, '%H:%i %d %b %y') AS 'creation_date' 
    FROM retweet
