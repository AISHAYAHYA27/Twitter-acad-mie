...
<div class="absolute top-0 sm:top-[50%] sm:left-[50%] sm:!-translate-[50%] bg-slate-100 dark:bg-black text-black dark:text-white sm:border-2 sm:rounded-2xl sm:w-fit max-w-full h-full sm:h-[600px] overflow-y-scroll">
    
    <!-- <div class="flex items-center justify-between px-4 py-6 sticky -top-6 z-99 bg-slate-100 dark:bg-black shadow-md"> -->
    <div class="flex items-center justify-between px-10 py-4 sticky top-0 left-0 w-full z-99 bg-slate-100 dark:bg-black shadow-md">
        <h3 class="leading-none">Editer mon profil</h3>
        <button class="close">
    ...
    <form class="w-[600px] sm:px-10 px-6 py-6 max-w-full" method="POST" action="/profil" enctype="multipart/form-data">
        ...
        <input type="submit" value="Sauvegarder"
            class="w-fit block cursor-pointer bg-white text-black px-4 py-2 mb-6 mx-auto rounded-lg border border-solid border-red-600 hover:bg-red-600 hover:text-white transition duration-300">
