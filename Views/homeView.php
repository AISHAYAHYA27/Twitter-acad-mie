<div class="grid grid-cols-10 gap-4 sm:p-6">
    ...
    <div
        ...
        <div id="wysiwyg"
            class=" max-w-full bg-white dark:bg-black rounded-3xl p-4 sm:p-6 md:p-8 lg:p-8 mt-2 dark:border-green-700">
            <div class="w-full pt-2 mt-4 border-t flex justify-between item-center">
                <ul class="flex gap-1">
                    ...
                    <li>
                        <button type="submit" title="Poster" class="w-fit block cursor-pointer dark:bg-white dark:text-black bg-black text-white  px-4 py-2 rounded-3xl hover:bg-red-600 hover:text-white transition duration-300">
                            Poster
                        </button>
                    </li>
                </ul>
